...
This project is part of my learning journey following roadmap.sh projects and practicing JavaScript and Node.js concepts.
...
Commands
Fetch recent activity for a user: node index.js github-activity kamranahmedse

Detailed mode to see more information and a summary: node index.js github-activity kamranahmedse detailed
